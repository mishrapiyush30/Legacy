...
from utils.data_loader import load_saved_cases, load_dataset, save_cases
...
class IndexManager:
    ...
    def save_indices(self) -> None:
        ...
        with self._lock:
            ...
            # Save cases
            save_cases(self.cases, self.config["cases_path"])
    ...
    def load_indices(self, embedding_service: Optional[EmbeddingService] = None) -> bool:
        ...
        with self._lock:
            ...
            if os.path.exists(self.config["cases_path"]):
                ...
                try:
                    self.cases = load_saved_cases(self.config["cases_path"])
